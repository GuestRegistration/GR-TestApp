<template>
    <div>
        ...
        <property-subscription-alert  v-if="property" :property="property" >
            Activate subscription for {{ property.name }} to manage reservation charges
        ...
        <template v-if="property && property.active">
            <v-alert
                ...
                type="warning">
                    <v-row align="center">
                    <v-col class="grow">
                        Stripe is not connected yet, you won't be able manage charges
                    </v-col>
                    <v-col class="shrink">
                        <router-link :to="{name: 'property.settings', params: {id: property.id, tab: 'gateway'}}" class="text-decoration-none">
                            <v-btn color="warning">Connect Stripe</v-btn>
                        </router-link>
                    </v-col>
                </v-row>
            </v-alert>
